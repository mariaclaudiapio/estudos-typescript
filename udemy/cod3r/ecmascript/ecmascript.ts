...
const turmaB: string[] = ['Fernando', 'Miguel', 'Lorena', ...turmaA] //com o operador spread essa operação pode ser feita
console.log(turmaB)
...
function tuplaParam2(...params: [number, string, boolean]) { //o "...params" é um array
